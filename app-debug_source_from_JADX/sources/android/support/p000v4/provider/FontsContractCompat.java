...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0089, code lost:
        sBackgroundThread.postAndReply(r2, new android.support.p000v4.provider.FontsContractCompat.C01473());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:39:0x0093, code lost:
        return null;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.graphics.Typeface getFontSync(final android.content.Context r8, final android.support.p000v4.provider.FontRequest r9, final android.support.p000v4.content.res.ResourcesCompat.FontCallback r10, final android.os.Handler r11, boolean r12, int r13, final int r14) {
        /*
        ...
        L_0x0063:
            ...
            monitor-enter(r5)
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.util.ArrayList<android.support.v4.provider.SelfDestructiveThread$ReplyCallback<android.support.v4.provider.FontsContractCompat$TypefaceResult>>> r6 = sPendingReplies     // Catch:{ all -> 0x0094 }
            boolean r7 = r6.containsKey(r0)     // Catch:{ all -> 0x0094 }
        ...
        L_0x007b:
            ...
            r7.add(r4)     // Catch:{ all -> 0x0094 }
            r6.put(r0, r7)     // Catch:{ all -> 0x0094 }
        L_0x0088:
            monitor-exit(r5)     // Catch:{ all -> 0x0094 }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static android.support.p000v4.provider.FontsContractCompat.FontInfo[] getFontFromProvider(android.content.Context r23, android.support.p000v4.provider.FontRequest r24, java.lang.String r25, android.os.CancellationSignal r26) {
        /*
            r1 = r25
        ...
        L_0x0148:
            r17 = 0
        L_0x014a:
            android.support.v4.provider.FontsContractCompat$FontInfo r9 = new android.support.v4.provider.FontsContractCompat$FontInfo     // Catch:{ all -> 0x0158 }
            r13 = r9
            r19 = 1
            r14 = r10
        ...
        L_0x015d:
            ...
            r12.close()
        L_0x0162:
            android.support.v4.provider.FontsContractCompat$FontInfo[] r0 = new android.support.p000v4.provider.FontsContractCompat.FontInfo[r2]
