...
public class DialogTitle extends TextView {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (layout != null && (lineCount = layout.getLineCount()) > 0 && layout.getEllipsisCount(lineCount - 1) > 0) {
            setSingleLine(false);
            setMaxLines(2);
            TypedArray a = getContext().obtainStyledAttributes((AttributeSet) null, C0228R.styleable.TextAppearance, 16842817, 16973892);
            int textSize = a.getDimensionPixelSize(C0228R.styleable.TextAppearance_android_textSize, 0);
            if (textSize != 0) {
