...
public class DrawableUtils {
    ...
    public static android.graphics.Rect getOpticalBounds(android.graphics.drawable.Drawable r11) {
        /*
            ...
            android.graphics.drawable.Drawable r0 = android.support.p000v4.graphics.drawable.DrawableCompat.unwrap(r11)     // Catch:{ Exception -> 0x0088 }
            r11 = r0
            java.lang.Class r0 = r11.getClass()     // Catch:{ Exception -> 0x0088 }
            java.lang.String r1 = "getOpticalInsets"
            r2 = 0
            java.lang.Class[] r3 = new java.lang.Class[r2]     // Catch:{ Exception -> 0x0088 }
            java.lang.reflect.Method r0 = r0.getMethod(r1, r3)     // Catch:{ Exception -> 0x0088 }
            java.lang.Object[] r1 = new java.lang.Object[r2]     // Catch:{ Exception -> 0x0088 }
            java.lang.Object r1 = r0.invoke(r11, r1)     // Catch:{ Exception -> 0x0088 }
            if (r1 == 0) goto L_0x0087
            android.graphics.Rect r3 = new android.graphics.Rect     // Catch:{ Exception -> 0x0088 }
            r3.<init>()     // Catch:{ Exception -> 0x0088 }
            java.lang.Class<?> r4 = sInsetsClazz     // Catch:{ Exception -> 0x0088 }
            java.lang.reflect.Field[] r4 = r4.getFields()     // Catch:{ Exception -> 0x0088 }
            int r5 = r4.length     // Catch:{ Exception -> 0x0088 }
            r6 = 0
        L_0x002b:
            if (r6 >= r5) goto L_0x0086
            r7 = r4[r6]     // Catch:{ Exception -> 0x0088 }
            java.lang.String r8 = r7.getName()     // Catch:{ Exception -> 0x0088 }
            r9 = -1
            int r10 = r8.hashCode()     // Catch:{ Exception -> 0x0088 }
            switch(r10) {
        ...
        L_0x003c:
            ...
            boolean r8 = r8.equals(r10)     // Catch:{ Exception -> 0x0088 }
        ...
        L_0x0066:
            goto L_0x0083
        L_0x0067:
            int r8 = r7.getInt(r1)     // Catch:{ Exception -> 0x0088 }
            r3.bottom = r8     // Catch:{ Exception -> 0x0088 }
            goto L_0x0083
        L_0x006e:
            int r8 = r7.getInt(r1)     // Catch:{ Exception -> 0x0088 }
            r3.right = r8     // Catch:{ Exception -> 0x0088 }
            goto L_0x0083
        L_0x0075:
            int r8 = r7.getInt(r1)     // Catch:{ Exception -> 0x0088 }
            r3.top = r8     // Catch:{ Exception -> 0x0088 }
            goto L_0x0083
        L_0x007c:
            int r8 = r7.getInt(r1)     // Catch:{ Exception -> 0x0088 }
            r3.left = r8     // Catch:{ Exception -> 0x0088 }
        L_0x0083:
            int r6 = r6 + 1
            goto L_0x002b
        L_0x0086:
