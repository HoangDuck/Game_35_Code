...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f51C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f52C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f53C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f54J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double d2 = (double) (daysSince2000 - f54J0);
        Double.isNaN(d2);
        float n = (float) Math.round(d2 - arcLongitude);
        double d3 = (double) (f54J0 + n);
        Double.isNaN(d3);
