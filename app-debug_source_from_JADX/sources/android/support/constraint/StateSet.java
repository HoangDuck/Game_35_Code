...
public class StateSet {
    ...
    private void load(android.content.Context r12, org.xmlpull.v1.XmlPullParser r13) {
        /*
            ...
            int[] r1 = android.support.constraint.C0026R.styleable.StateSet
        ...
        L_0x000f:
            ...
            int r5 = android.support.constraint.C0026R.styleable.StateSet_defaultState
        ...
        L_0x0024:
            ...
            r4 = 0
            r5 = 0
            int r6 = r13.getEventType()     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
        L_0x002b:
            r7 = 1
        ...
        L_0x0033:
            goto L_0x00b3
        L_0x0035:
            java.lang.String r7 = r13.getName()     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            boolean r7 = r8.equals(r7)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
        ...
        L_0x0040:
            ...
            goto L_0x00b3
        L_0x0043:
            java.lang.String r9 = r13.getName()     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            r3 = r9
            r9 = -1
            int r10 = r3.hashCode()     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            switch(r10) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
        L_0x0050:
            goto L_0x0076
        L_0x0051:
            java.lang.String r7 = "Variant"
            boolean r7 = r3.equals(r7)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            if (r7 == 0) goto L_0x0050
            r7 = 3
            goto L_0x0077
        L_0x005b:
            boolean r8 = r3.equals(r8)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
        ...
        L_0x007a:
            ...
            goto L_0x0098
        L_0x007d:
            android.support.constraint.StateSet$Variant r7 = new android.support.constraint.StateSet$Variant     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            r7.<init>(r12, r13)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            if (r5 == 0) goto L_0x00ac
            r5.add(r7)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            goto L_0x00ac
        L_0x0088:
            android.support.constraint.StateSet$State r7 = new android.support.constraint.StateSet$State     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            r7.<init>(r12, r13)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            r5 = r7
            android.util.SparseArray<android.support.constraint.StateSet$State> r7 = r11.mStateList     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            int r8 = r5.mId     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            r7.put(r8, r5)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            goto L_0x00ac
        L_0x0096:
            goto L_0x00ac
        L_0x0097:
            goto L_0x00ac
        L_0x0098:
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            r8.<init>()     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            java.lang.String r9 = "unknown tag "
            r8.append(r9)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            r8.append(r3)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            java.lang.String r8 = r8.toString()     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            android.util.Log.v(r7, r8)     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
        L_0x00ac:
            goto L_0x00b3
        L_0x00ad:
            java.lang.String r7 = r13.getName()     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            r4 = r7
        L_0x00b3:
            int r7 = r13.next()     // Catch:{ XmlPullParserException -> 0x00c0, IOException -> 0x00bb }
            r6 = r7
            goto L_0x002b
        L_0x00ba:
            goto L_0x00c4
    ...
    static class State {
        ...
        public State(Context context, XmlPullParser parser) {
            TypedArray a = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0026R.styleable.State);
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0026R.styleable.State_android_id) {
                    this.mId = a.getResourceId(attr, this.mId);
                } else if (attr == C0026R.styleable.State_constraints) {
    ...
    static class Variant {
        ...
        public Variant(Context context, XmlPullParser parser) {
            TypedArray a = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0026R.styleable.Variant);
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0026R.styleable.Variant_constraints) {
                    this.mConstraintID = a.getResourceId(attr, this.mConstraintID);
                    String type = context.getResources().getResourceTypeName(this.mConstraintID);
                    String resourceName = context.getResources().getResourceName(this.mConstraintID);
                    if ("layout".equals(type)) {
                ...
                } else if (attr == C0026R.styleable.Variant_region_heightLessThan) {
                    this.mMaxHeight = a.getDimension(attr, this.mMaxHeight);
                } else if (attr == C0026R.styleable.Variant_region_heightMoreThan) {
                    this.mMinHeight = a.getDimension(attr, this.mMinHeight);
                } else if (attr == C0026R.styleable.Variant_region_widthLessThan) {
                    this.mMaxWidth = a.getDimension(attr, this.mMaxWidth);
                } else if (attr == C0026R.styleable.Variant_region_widthMoreThan) {
