    ...
    public void defineTerminalWidgets(ConstraintWidget.DimensionBehaviour horizontalBehavior, ConstraintWidget.DimensionBehaviour verticalBehavior) {
        if (this.mNeedBuildGraph) {
            ...
            if (!hasBarrier) {
                ...
                while (it2.hasNext()) {
                    it2.next().defineTerminalWidgets(horizontalBehavior == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT ? USE_GROUPS : false, verticalBehavior == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT ? USE_GROUPS : false);
                }
            }
        }
    }
