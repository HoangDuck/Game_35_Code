...
public class BarrierReference extends HelperReference {
    ...
    public void apply() {
        getHelperWidget();
        int direction = 0;
        switch (C00391.f26x83030585[this.mDirection.ordinal()]) {
            case 1:
            case 2:
                direction = 0;
                break;
    ...
    static /* synthetic */ class C00391 {
        ...
        static final /* synthetic */ int[] f26x83030585;
        ...
        static {
            ...
            try {
                f26x83030585[State.Direction.START.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f26x83030585[State.Direction.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f26x83030585[State.Direction.END.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f26x83030585[State.Direction.TOP.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f26x83030585[State.Direction.BOTTOM.ordinal()] = 6;
