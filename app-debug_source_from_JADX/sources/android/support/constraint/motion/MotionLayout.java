...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent2 {
    ...
    public void setState(TransitionState newState) {
        if (newState != TransitionState.FINISHED || this.mCurrentState != -1) {
            ...
            switch (C00312.f8xe3ac6329[oldState.ordinal()]) {
                case 1:
                case 2:
    ...
    static /* synthetic */ class C00312 {
        ...
        static final /* synthetic */ int[] f8xe3ac6329;
        ...
        static {
            ...
            try {
                f8xe3ac6329[TransitionState.SETUP.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f8xe3ac6329[TransitionState.MOVING.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f8xe3ac6329[TransitionState.FINISHED.ordinal()] = 4;
    ...
    private static class MyTracker implements MotionTracker {
        ...
        /* renamed from: me */
        private static MyTracker f9me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f9me.tracker = VelocityTracker.obtain();
            return f9me;
        }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, C0026R.styleable.MotionLayout);
            int N = a.getIndexCount();
            boolean apply = true;
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0026R.styleable.MotionLayout_layoutDescription) {
                    this.mScene = new MotionScene(getContext(), this, a.getResourceId(attr, -1));
                } else if (attr == C0026R.styleable.MotionLayout_currentState) {
                    this.mCurrentState = a.getResourceId(attr, -1);
                } else if (attr == C0026R.styleable.MotionLayout_motionProgress) {
                    this.mTransitionGoalPosition = a.getFloat(attr, 0.0f);
                    this.mInTransition = true;
                } else if (attr == C0026R.styleable.MotionLayout_applyMotionScene) {
                    apply = a.getBoolean(attr, apply);
                } else {
                    int i2 = 0;
                    if (attr == C0026R.styleable.MotionLayout_showPaths) {
                    ...
                    } else if (attr == C0026R.styleable.MotionLayout_motionDebug) {
