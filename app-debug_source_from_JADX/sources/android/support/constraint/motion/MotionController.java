...
public class MotionController {
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f10x;
        start.top = this.mStartMotionPath.f11y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f10x;
        end.top = this.mEndMotionPath.f11y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f10x - this.mStartMotionPath.f10x;
        float dy = this.mEndMotionPath.f11y - this.mStartMotionPath.f11y;
        float startCenterX = this.mStartMotionPath.f10x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f11y + (this.mStartMotionPath.height / 2.0f);
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float float_l = this.mStartMotionPath.f10x + ((this.mEndMotionPath.f10x - this.mStartMotionPath.f10x) * position);
            float float_t = this.mStartMotionPath.f11y + ((this.mEndMotionPath.f11y - this.mStartMotionPath.f11y) * position);
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f10x - this.mStartMotionPath.f10x;
        float dTop = this.mEndMotionPath.f11y - this.mStartMotionPath.f11y;
