...
public class MotionScene {
    ...
    public static class Transition {
        ...
        static class TransitionOnClick implements View.OnClickListener {
            ...
            public TransitionOnClick(Context context, Transition transition, XmlPullParser parser) {
                ...
                TypedArray a = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0026R.styleable.OnClick);
                int N = a.getIndexCount();
                for (int i = 0; i < N; i++) {
                    int attr = a.getIndex(i);
                    if (attr == C0026R.styleable.OnClick_targetId) {
                        this.mTargetId = a.getResourceId(attr, this.mTargetId);
                    } else if (attr == C0026R.styleable.OnClick_clickAction) {
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0026R.styleable.Transition);
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray a) {
            ...
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0026R.styleable.Transition_constraintSetEnd) {
                ...
                } else if (attr == C0026R.styleable.Transition_constraintSetStart) {
                ...
                } else if (attr == C0026R.styleable.Transition_motionInterpolator) {
                ...
                } else if (attr == C0026R.styleable.Transition_duration) {
                    this.mDuration = a.getInt(attr, this.mDuration);
                } else if (attr == C0026R.styleable.Transition_staggered) {
                    this.mStagger = a.getFloat(attr, this.mStagger);
                } else if (attr == C0026R.styleable.Transition_autoTransition) {
                    this.mAutoTransition = a.getInteger(attr, this.mAutoTransition);
                } else if (attr == C0026R.styleable.Transition_android_id) {
                    this.mId = a.getResourceId(attr, this.mId);
                } else if (attr == C0026R.styleable.Transition_transitionDisable) {
                    this.mDisable = a.getBoolean(attr, this.mDisable);
                } else if (attr == C0026R.styleable.Transition_pathMotionArc) {
                    this.mPathMotionArc = a.getInteger(attr, -1);
                } else if (attr == C0026R.styleable.Transition_layoutDuringTransition) {
                    this.mLayoutDuringTransition = a.getInteger(attr, 0);
                } else if (attr == C0026R.styleable.Transition_transitionFlags) {
    ...
    MotionScene(Context context, MotionLayout layout, int resourceID) {
        ...
        this.mConstraintSetMap.put(C0026R.C0028id.motion_base, new ConstraintSet());
        this.mConstraintSetIdMap.put("motion_base", Integer.valueOf(C0026R.C0028id.motion_base));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:50:0x00fb, code lost:
        if (android.support.constraint.motion.MotionScene.Transition.access$1200(r4) != false) goto L_0x0110;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:52:0x0103, code lost:
        if (android.support.constraint.motion.MotionScene.Transition.access$200(r4) == null) goto L_0x0110;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x0114, code lost:
        if (android.support.constraint.motion.MotionScene.Transition.access$1200(r4) == false) goto L_0x0142;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x011a, code lost:
        if (android.support.constraint.motion.MotionScene.Transition.access$000(r4) != -1) goto L_0x011f;
     */
    ...
    private void load(android.content.Context r12, int r13) {
        ...
        L_0x008b:
            goto L_0x012e
        L_0x008d:
            android.support.constraint.motion.KeyFrames r6 = new android.support.constraint.motion.KeyFrames     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        ...
        L_0x009b:
            ...
            goto L_0x0142
        L_0x00a0:
            android.support.constraint.StateSet r6 = new android.support.constraint.StateSet     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.<init>(r12, r1)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        ...
        L_0x00dd:
            android.support.constraint.motion.TouchResponse r6 = new android.support.constraint.motion.TouchResponse     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            android.support.constraint.motion.MotionLayout r7 = r11.mMotionLayout     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            r6.<init>(r12, r7, r1)     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            android.support.constraint.motion.TouchResponse unused = r4.mTouchResponse = r6     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            goto L_0x0142
        L_0x00e8:
            java.util.ArrayList<android.support.constraint.motion.MotionScene$Transition> r6 = r11.mTransitionList     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            android.support.constraint.motion.MotionScene$Transition r7 = new android.support.constraint.motion.MotionScene$Transition     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            ...
            android.support.constraint.motion.MotionScene$Transition r6 = r11.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            ...
            android.support.constraint.motion.TouchResponse r6 = r4.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            if (r6 == 0) goto L_0x0110
            android.support.constraint.motion.MotionScene$Transition r6 = r11.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
            android.support.constraint.motion.TouchResponse r6 = r6.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
        ...
        L_0x0110:
            ...
            goto L_0x0124
        L_0x011f:
            java.util.ArrayList<android.support.constraint.motion.MotionScene$Transition> r6 = r11.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x0156, IOException -> 0x0151 }
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser parser) {
        TypedArray a = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0026R.styleable.MotionScene);
        int count = a.getIndexCount();
        for (int i = 0; i < count; i++) {
            int attr = a.getIndex(i);
            if (attr == C0026R.styleable.MotionScene_defaultDuration) {
                this.mDefaultDuration = a.getInt(attr, this.mDefaultDuration);
            } else if (attr == C0026R.styleable.MotionScene_layoutDuringTransition) {
                this.mLayoutDuringTransition = a.getInteger(attr, 0);
            }
        }
        a.recycle();
