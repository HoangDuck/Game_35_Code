...
public class ConstraintAttribute {
    ...
    static /* synthetic */ class C00241 {
        ...
        static final /* synthetic */ int[] f3x8b8e6cb4;
        ...
        static {
            ...
            try {
                f3x8b8e6cb4[AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f3x8b8e6cb4[AttributeType.INT_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f3x8b8e6cb4[AttributeType.FLOAT_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f3x8b8e6cb4[AttributeType.STRING_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f3x8b8e6cb4[AttributeType.BOOLEAN_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f3x8b8e6cb4[AttributeType.DIMENSION_TYPE.ordinal()] = 7;
    ...
    public int noOfInterpValues() {
        switch (C00241.f3x8b8e6cb4[this.mType.ordinal()]) {
            case 1:
            case 2:
                return 4;
            default:
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String name : map.keySet()) {
            ...
            try {
                switch (C00241.f3x8b8e6cb4[constraintAttribute.mType.ordinal()]) {
                    case 1:
    ...
    public static void parse(Context context, XmlPullParser parser, HashMap<String, ConstraintAttribute> custom) {
        TypedArray a = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0026R.styleable.CustomAttribute);
        String name = null;
        Object value = null;
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (attr == C0026R.styleable.CustomAttribute_attributeName) {
                name = a.getString(attr);
                if (name != null && name.length() > 0) {
                    name = Character.toUpperCase(name.charAt(0)) + name.substring(1);
                }
            } else if (attr == C0026R.styleable.CustomAttribute_customBoolean) {
                value = Boolean.valueOf(a.getBoolean(attr, false));
                type = AttributeType.BOOLEAN_TYPE;
            } else if (attr == C0026R.styleable.CustomAttribute_customColorValue) {
                type = AttributeType.COLOR_TYPE;
                value = Integer.valueOf(a.getColor(attr, 0));
            } else if (attr == C0026R.styleable.CustomAttribute_customColorDrawableValue) {
                type = AttributeType.COLOR_DRAWABLE_TYPE;
                value = Integer.valueOf(a.getColor(attr, 0));
            } else if (attr == C0026R.styleable.CustomAttribute_customPixelDimension) {
            ...
            } else if (attr == C0026R.styleable.CustomAttribute_customDimension) {
                type = AttributeType.DIMENSION_TYPE;
                value = Float.valueOf(a.getDimension(attr, 0.0f));
            } else if (attr == C0026R.styleable.CustomAttribute_customFloatValue) {
                type = AttributeType.FLOAT_TYPE;
                value = Float.valueOf(a.getFloat(attr, Float.NaN));
            } else if (attr == C0026R.styleable.CustomAttribute_customIntegerValue) {
                type = AttributeType.INT_TYPE;
                value = Integer.valueOf(a.getInteger(attr, -1));
            } else if (attr == C0026R.styleable.CustomAttribute_customStringValue) {
